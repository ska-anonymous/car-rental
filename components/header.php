    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="../dist/img/car.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            ...
            <div class="sidebar mt-2">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        if ($_SESSION['user']['user_role'] == 'admin') {
                            ...
                            ?>
                            <li class="nav-item">
                                <a href="add_car.php" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="cars_list.php" class="nav-link">
                        ...
                        ?>
                        <li class="nav-item">
                            <a href="browse_cars.php" class="nav-link">
